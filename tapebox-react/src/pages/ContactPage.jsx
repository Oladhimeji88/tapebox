...
export default function ContactPage() {
  ...
  return (
    <main className="flex-1 max-w-4xl mx-auto p-8 w-full">
      <h2 className="text-3xl sm:text-4xl text-green-700 font-medium mb-4">Get In Touch</h2>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
        <div className="bg-white p-8 rounded-lg shadow-md">
          <h3 className="text-xl text-green-700 font-medium mb-6">Send us a message</h3>
        ...
        <div className="bg-white p-8 rounded-lg shadow-md">
          <h3 className="text-xl text-green-700 font-medium mb-6">Contact Information</h3>
          <div className="space-y-6">
            ...
            <div>
              ...
              <p className="text-gray-600"><a href="tel:08140450440" className="text-green-600 hover:text-green-700">08140450440</a></p>
            </div>
            <div>
              <h4 className="font-medium text-gray-900 mb-2">✉️ Email</h4>
              <p className="text-gray-600"><a href="mailto:balogujeremiah.8@gmail.com" className="text-green-600 hover:text-green-700">balogujeremiah.8@gmail.com</a></p>
            </div>
            <div>
